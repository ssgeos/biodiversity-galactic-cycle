...
![biodiversity cycle](figures/biodiversity-cycle.png)
...
$$
P_4(R) \sim \frac{P_\phi(R)}{4} \sim \frac{\pi R}{2\,\Theta(R)}
$$
<h6 align="center">
  (formula 1)
</h6>
...
A 540 Myr window is more than two galactic years. Ordinary epicyclic motion only swings R by a few hundred parsecs and changes P<sub>ϕ</sub> by a few percent. Radial migration can move the guiding radius by kiloparsecs over the Sun’s lifetime, but much of that may have happened early. The last two orbits need not place the Sun in a different regime. If they still drifted R by ~0.5–1 kpc, P<sub>ϕ</sub>/4 would wander by ~6–12% ‒ still about 60 Myr, wide enough to blur a sharp 62 ± 3 Myr Fourier peak if the drift were steady.
